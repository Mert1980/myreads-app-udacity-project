...
![Home Page](public/screenshots/load-app.png "landing page")

## How to Use the App

- Books are sorted into three categories: Currently Reading, Want to Read and Read
- To change a book's category or remove a book from the list, click on the green button on the book cover
  ![Change menu](public/screenshots/change-shelf.png "change")
...
![Search Screen](public/screenshots/search-books.png "search")
...
- [Project starter template](https://github.com/udacity/reactnd-project-myreads-starter) (includes backend server documentation)
